 ...
 * Highlights the current step and links the rest.
 */
export function WorkflowStepper({ current }) {
  ...
  return (
    <nav
      ...
      className="flex flex-wrap items-center gap-1.5 rounded-[var(--radius-lg)] border border-[var(--border-light)] bg-[var(--bg-card)] px-3 py-2.5 shadow-[var(--shadow-xs)]"
    >
